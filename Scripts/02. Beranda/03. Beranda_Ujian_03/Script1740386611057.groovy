...
WebUI.scrollToElement(findTestObject('Beranda/03. Ujian BP_Pemahaman dan Pengetahuan Umum/xpath_soal_ujian_no20'), 2)

WebUI.click(findTestObject('Beranda/03. Ujian BP_Pemahaman dan Pengetahuan Umum/xpath_soal_ujian_no20'))
